    ...
    <>
      <div className="relative bg-gradient-to-b from-slate-900 to-amber-950 w-full h-[895px] grid grid-cols-4 grid-row-3 gap-0">
        <div className=" h-96 w-full ">
           <img className="m-auto h-80 w-96 " src="https://images.unsplash.com/photo-1551632811-561732d1e306?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8dHJla2luZ3xlbnwwfHwwfHx8MA%3D%3D" alt="" />
        </div>
        <div className="  col-span-3 relative">
          <div className="ml-auto    h-96 absolute inset-x-10 bottom-10 opacity-80 w-[900px]  border-b-4 border-white">
             <h1 className="bg-gradient-to-l from-blue-500    h-28 text-right  font-mono text-white font-extrabold text-6xl">Treking</h1>
        ...
        <div className="  col-span-3 relative">
          <div className="mr-auto  h-96 absolute inset-x-10 bottom-10 opacity-80 w-[900px]  border-b-4 border-white">
            <h1 className="bg-gradient-to-r from-amber-500 from-10% h-28 text-left  font-mono text-white font-extrabold text-6xl">Water_fun</h1>
            <p className="italic text-center text-xl text-white font-extrabold">
        ...
        <div className=" h-96 w-full">
          <img className="m-auto h-80 w-96 " src="https://images.unsplash.com/photo-1443397646383-16272048780e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fHRyYXZlbCUyMHNlYXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
        </div>
